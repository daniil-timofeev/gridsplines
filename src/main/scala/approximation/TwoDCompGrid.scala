...
import approximation.TwoDCompGrid.{Dir, Side, XDir, YDir}
...
/**
  *
  */
 class TwoDCompGrid[XType <: TypeDir, YType <: TypeDir](lowerX: Array[Double],
                                                        rangeX: Array[Double],
                                                        upperX: Array[Double],
                                                        xBeginAt: Array[Int],
                                                        xEndAt: Array[Int],
  ...
  private val xPreDef: Array[Array[Double]] = {
    ...
    val ranges: Array[Array[Double]] = (xBeginAt, xEndAt).zipped.map((x0, xn) => TwoDCompGrid.sliceX(x0, rangeX, xn))
...
object TwoDCompGrid{
  ...
  def apply[XType <: TypeDir, YType  <: TypeDir](leftX: Array[Double], coordX: Array[Double], rightX: Array[Double],
                                             ...
                                             (implicit dir1: XType, dir2: YType): TwoDCompGrid[XType, YType] = {
    ...
    new TwoDCompGrid[XType, YType](leftX, coordX, rightX, xStartAt, xEndsAt, leftY, coordY, rightY, conductivities, weight)
    }
