...
val capacitySpline =
  Spline[M1Hermite3](capacitySources)

val volCapacitySpline = spline.*(capacitySpline)

volCapacitySpline.toString

volCapacitySpline(110)

volCapacitySpline(150)

volCapacitySpline(135)
